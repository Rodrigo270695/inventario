...
<head>
    <meta charset="UTF-8">
    <title>Ticket de reparación aprobado</title>
    <style>
        ...
        .header { background: #16a34a; color: #ffffff; padding: 20px 24px; }
        ...
        .button { display: inline-block; margin-top: 20px; background: #16a34a; color: #ffffff !important; text-decoration: none; padding: 10px 16px; border-radius: 8px; font-weight: 700; }
        .muted { color: #6b7280; }
    </style>
</head>
<body>
    <div class="container">
        <div class="header">
            <h1>Ticket de reparación aprobado</h1>
            <div>El ticket <strong>{{ $ticket->code }}</strong> ha sido aprobado. Puede proceder con el diagnóstico y la reparación.</div>
        </div>
        ...
        <div class="content">
            <p class="meta">
                ...
                <strong>Fecha de aprobación:</strong> {{ optional($ticket->approved_at)->format('d/m/Y H:i') ?? '—' }}
            </p>
