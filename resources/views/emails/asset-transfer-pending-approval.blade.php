...
<body>
    <div class="container">
        <div class="header">
            <h1>Traslado pendiente de aprobación</h1>
            <div>Se registró el traslado <strong>{{ $transfer->code }}</strong> y requiere revisión.</div>
        </div>
        ...
        <div class="content">
            <p class="meta">
                ...
                <strong>Fecha de registro:</strong> {{ optional($transfer->created_at)->format('d/m/Y H:i') ?? '—' }}
            </p>
