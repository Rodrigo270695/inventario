@php
    ...
    $headline = match ($action) {
        'approved' => 'Orden aprobada en zonal',
        'rejected' => 'Orden rechazada en zonal',
        'observed' => 'Orden en observación (zonal)',
        default => 'Actualización de orden (zonal)',
    };

    $badgeText = match ($action) {
        'approved' => 'Aprobada zonal',
        'rejected' => 'Rechazada zonal',
        'observed' => 'Observada zonal',
