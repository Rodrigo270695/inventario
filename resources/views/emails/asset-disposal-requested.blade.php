...
<body>
    <div class="container">
        <div class="header">
            ...
            <div>Se registró una solicitud de baja que requiere tu revisión y aprobación.</div>
        </div>

        <div class="content">
            <p class="meta">
                <strong>Estado:</strong> <span class="badge">Solicitado</span><br>
                <strong>Solicitado por:</strong> {{ $creatorName }}<br>
                <strong>Ubicación:</strong> {{ $path($disposal->warehouse) }}<br>
                <strong>Fecha y hora de registro:</strong> {{ optional($disposal->created_at)->format('d/m/Y H:i') ?? '—' }}
            </p>
