    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'La autenticación en dos pasos está activada. Escanee el código QR o ingrese la clave en su aplicación de autenticación.',
                buttonText: 'Cerrar',
            };
        }
        ...
        return {
            ...
            description:
                'Para terminar, escanee el código QR o ingrese la clave en su aplicación de autenticación',
            buttonText: 'Continuar',
        };
